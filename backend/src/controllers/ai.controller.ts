...
1. JavaScript code (apiCode) to fetch data from the Xero API. Do not include dependencies on any external libraries. Do not call console.warn or console.error. Instead call console.log. Be aware that any dates returned by the Xero API will be in Microsoft JSON Date format so make sure the code can handle this.
2. React code (renderCode) using ApexCharts to visualize the data. Do not include any import statements.
...
When modifying the API code, do not include dependencies on any external libraries. Also do not call console.warn or console.error. Instead call console.log. Also, be aware that any dates returned by the Xero API will be in Microsoft JSON Date format so make sure the code can handle this.
...
{
  "name": "An updated descriptive name for the report",
  "description": "Updated brief description of what the report shows",
  "apiCode": "...", // The complete updated API code as a JSON-escaped string
  "renderCode": "..." // The complete updated Render code as a JSON-escaped string
}

Handling Vague Requests:
If the user's modification request is too vague or lacks necessary information, output ONLY this specific JSON structure:
{
  "needsMoreInfo": true,
  "name": "Incomplete Modification Request",
  "description": "More information is needed for modification",
  "requiredInfo": ["List of required information"]
}
